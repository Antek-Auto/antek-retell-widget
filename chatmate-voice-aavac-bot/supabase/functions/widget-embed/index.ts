...
(function() {
  ...
  function initWidget(config) {
    ...
    style.textContent = \`
      ...
      .retell-widget-attribution { padding: 8px 16px; border-top: 1px solid rgba(255,255,255,0.1); text-align: center; font-size: 11px; color: rgba(255,255,255,0.7); background: rgba(0,0,0,0.2); flex-shrink: 0; }
      .retell-widget-attribution a { color: rgba(255,255,255,0.8); text-decoration: none; transition: color 0.2s; }
    ...
    panel.innerHTML = \`
      ...
      <div class="retell-widget-content">
        ...
        \${config.attribution_link ? '<div class="retell-widget-attribution">Powered by <a href="' + config.attribution_link + '" target="_blank" rel="noopener noreferrer">' + (config.attribution_text || 'Antek Automation') + '</a></div>' : ''}
      </div>
    \`;
