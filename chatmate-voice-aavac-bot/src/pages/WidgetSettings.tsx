      ...
      <main className="container mx-auto px-6 py-8 max-w-2xl">
        ...
        <div className="space-y-8">
          ...
          <section className="glass rounded-xl p-6 space-y-6">
            ...
            <p className="text-sm text-muted-foreground">
              Enter agent IDs to connect voice and chat. The API key from Settings will be used if not specified below.
            </p>

            <div className="space-y-2">
              <Label htmlFor="retellApiKey">Retell API Key (Optional Override)</Label>
              <Input
                id="retellApiKey"
                type="password"
                value={retellApiKey}
                onChange={(e) => setRetellApiKey(e.target.value)}
                placeholder="Leave blank to use global API key from Settings"
              />
              <p className="text-xs text-muted-foreground">
                Leave blank to use the global API key configured in{" "}
                <Link to="/settings" className="text-primary hover:underline">
                  Settings
                </Link>
                . Enter a custom key here only if you need a different Retell account for this widget.
              </p>
            </div>
